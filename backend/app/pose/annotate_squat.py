...
from app.detectors.squat import MODEL, scaler, extract_full_landmarks

def analyze_and_annotate_squat(video_path, output_path):
    ...
    while True:
        ...
        if res.pose_landmarks:
            ...
            label = "BAD SQUAT" if p>0.5 else "GOOD SQUAT"
    ...
    verdict = "BAD SQUAT" if bad_ratio > 0.30 else "GOOD SQUAT"
